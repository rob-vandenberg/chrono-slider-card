      ...
      <ha-card class="ha-card">
        ...
        <div class="controls">
          <div class="main-control">
            <div
              class=${classMap({slider:!0,active:"slider"===this._toggleMode})}
              role="slider"
              tabindex="0"
            ...
            <div class=${classMap({"control-button-group":!0,active:"buttons"===this._toggleMode})}>
              <button
          ...
          ${this._showControlSwitchButtons?html`
                <div class="control-switch-buttons">
                  <button
                    class=${classMap({"control-switch-button":!0,"control-switch-slider-mode":!0,selected:"slider"===this._toggleMode})}
                  ...
                  <button
                    class=${classMap({"control-switch-button":!0,"control-switch-buttons-mode":!0,selected:"buttons"===this._toggleMode})}
        ...
        ${this._showFavorites?html`
              <section class="favorites">
                ${this._favoritePositions.map(t=>html`
                    <div
                      class=${classMap({"favorite-button":!0,[`favorite-button-${t.value}`]:!0,active:t.value===e})}
                      @click=${()=>this._applyFavorite(t.value)}
                    >
