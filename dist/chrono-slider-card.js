        ...
        <div class="controls">
          <div class="main-control">
            <div
              ...
              style=${styleMap({"--state-cover-inactive-color":r,"--control-slider-color":a,"--control-slider-background":a})}
            >
              <div
                class="container"
            ...
            <div class=${classMap({"control-button-group":!0,active:"button"===this._toggleMode})}>
              <button
                class=${classMap({"control-btn":!0,"control-btn-close":!0,disabled:h})}
                @click=${()=>this._callDirectional("close")}
                aria-label="Close"
              >
                <svg viewBox="0 0 24 24"><path d=${g}></path></svg>
              </button>
              <button
                class=${classMap({"control-btn":!0,"control-btn-stop":!0,disabled:p})}
              ...
              <button
                class=${classMap({"control-btn":!0,"control-btn-open":!0,disabled:d})}
                @click=${()=>this._callDirectional("open")}
                aria-label="Open"
              >
                <svg viewBox="0 0 24 24"><path d=${u}></path></svg>
              </button>
            </div>
          </div>
